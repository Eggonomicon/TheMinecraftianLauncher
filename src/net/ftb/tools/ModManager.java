...
public class ModManager extends JDialog {
	...
	public class ModManagerWorker extends SwingWorker<Boolean, Void> {
		...
		protected boolean downloadModPack(String modPackName, String dir) {
			...
			try { /* Eggnomicon says this is where the problem starts */
				...
				/* if((md5 == null || md5.isEmpty()) ? DownloadUtils.isValid(new File(baseDynamic, modPackName), md5) : DownloadUtils.backupIsValid(new File(baseDynamic, modPackName), baseLink + modPackName) ) { */
