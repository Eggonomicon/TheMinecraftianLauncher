...
public class OSUtils {
	...
	public static String getDynamicStorageLocation() {
		switch(getCurrentOS()) {
		case WINDOWS:
			return System.getenv("APPDATA") + "/minecraftianlauncher/";
		case MACOSX:
			return cachedUserHome + "/Library/Application Support/minecraftianlauncher/";
		case UNIX:
			return cachedUserHome + "/.minecraftianlauncher/";
		default:
