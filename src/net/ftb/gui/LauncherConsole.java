...
public class LauncherConsole extends JFrame implements ILogListener {
	private final static String launcherLogFile = "MinecraftianLauncherLog.txt";
		...
		ircButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				if (Desktop.isDesktopSupported()) {
					...
					try {
						desktop.browse(new URI("http://theminecraftian.com/index.php?/forum/22-launcher-support/"));
					} catch (Exception exc) {
